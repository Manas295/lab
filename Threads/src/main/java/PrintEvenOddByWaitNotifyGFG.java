public class PrintEvenOddByWaitNotifyGFG {
    ...
    PrintEvenOddByWaitNotifyGFG (int limit) {this.limit = limit;}
  ...
  //function to print odd numbers
    ...
    public static void main(String[] args) {
        PrintEvenOddByWaitNotifyGFG printer = new PrintEvenOddByWaitNotifyGFG (10);
